package com.example.dictionaryvocabimprovement.Adapters;
...
import com.example.dictionaryvocabimprovement.Models.Phonetics;
import com.example.dictionaryvocabimprovement.R;
import com.example.dictionaryvocabimprovement.ViewHolders.PhoneticViewHolder;
            ...
            public void onClick(View view) {
                ...
                if (adapterPosition != RecyclerView.NO_POSITION) {
                    ...
                    try {
                        ...
                        player.setDataSource(phoneticsList.get(adapterPosition).getAudio());
                        player.prepare();
                        player.start();
                    } catch (Exception e) {
                        e.printStackTrace();
